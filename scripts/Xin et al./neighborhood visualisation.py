    ...
    for file in os.listdir(paths): #goes throw all files in a folder
        ...
        if filedir.endswith("CD8_neighborhood.csv"):
            ...
            try:
                ...
                # Show the plot
                #plt.show()
                fig.savefig(str(filedir) + "CD8_neighborhood_vis",dpi=300)
                plt.close()
                ...
                colors = ['#44933a', '#334385', '#a92121', '#6a127c', 'gray','yellow']
                ...
                #plt.show()
                fig.savefig(str(filedir) + "CD8_immune_neighborhood_vis", dpi=300)
                plt.close()
            except statistics.StatisticsError:
                print('This file hase nothing to calculate')
                print('------')
