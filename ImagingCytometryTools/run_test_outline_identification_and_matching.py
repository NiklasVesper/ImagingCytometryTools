...
from ImagingCytometryTools.visualize_data import test_outline_identification_and_matching
        ...
        for file in os.listdir(paths):
            ...
            if filedir.endswith(".csv"):
                ...
                if filestring in filename_string:
                    ...
                    test_outline_identification_and_matching(filedir_pd, new_folder_name, filedir_outline_image, show_individual_cells, show_nucleus)