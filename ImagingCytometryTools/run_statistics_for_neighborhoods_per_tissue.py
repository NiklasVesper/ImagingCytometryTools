...
def run_statistics_for_neighborhoods_per_tissue(directory, filestring, df_column, output_folder, phenotypes, surrounding_phenotypes, colors, add_mixed_cells = False, select_neighbors = [False]):
