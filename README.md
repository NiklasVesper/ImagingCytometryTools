...
ImagingCytometryTools is a collection of scripts that allows the user to generate subcellular information out of the cellular segmentation. The with a focus on Imaging Mass Cytometry, 
